...
OpenBao supports two primary methods for managing external plugins:

### Traditional plugin management

The traditional approach involves manually placing plugin binaries in the plugin directory and registering them through the CLI or API.
...
- **Declarative configuration** of plugins in server config files
...
See the [OCI Plugin Management Guide](/docs/plugins/oci-plugins) for detailed information on configuring and using OCI-based plugins.
