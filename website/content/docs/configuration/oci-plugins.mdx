...
## `plugin_download_on_error_behavior`
...
- `"fail_startup"` `(default)` - Server startup fails if any plugin download fails
- `"warn_only"` - Log warnings for failed downloads but continue startup
